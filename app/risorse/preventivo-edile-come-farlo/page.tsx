...
export const metadata: Metadata = {
  ...
  openGraph: { url: "/risorse/preventivo-edile-come-farlo", title: article.title, description: article.description, type: "article", images: [article.cover ?? "/opengraph-image"] },
};
