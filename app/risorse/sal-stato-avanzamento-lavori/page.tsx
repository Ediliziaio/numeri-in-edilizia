...
export const metadata: Metadata = {
  ...
  openGraph: { url: "/risorse/sal-stato-avanzamento-lavori", title: article.title, description: article.description, type: "article", images: [article.cover ?? "/opengraph-image"] },
};
